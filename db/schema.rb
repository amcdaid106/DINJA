...
ActiveRecord::Schema.define(version: 20160829163928) do
  ...
  create_table "banned_ingredients", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["ingredient_id"], name: "index_banned_ingredients_on_ingredient_id", using: :btree
    t.index ["user_id"], name: "index_banned_ingredients_on_user_id", using: :btree
  end
  ...
  add_foreign_key "banned_ingredients", "ingredients"
  add_foreign_key "banned_ingredients", "users"
