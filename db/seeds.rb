...
vegetarian: true, gluten_free: true, egg_free: true, dairy_free: true, vegan: true)

Dose.create(measure: "400g of", ingredient:chickpea, recipe: Houmous)
Dose.create(measure: "100g of", ingredient:peanut, recipe: Houmous)
